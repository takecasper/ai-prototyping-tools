...
const CONFIG = {
  ...
  CANONICAL_HINTS: {
    ...
    a: 'Canonical name="Button"',
    img: 'Canonical name="Image"',
    image: 'Canonical name="Image"',
    svg: 'Canonical name="Icon"',
    i: 'Canonical name="Icon"',
    input: "a canonical form piece",
    select: "a canonical form piece",
    textarea: "a canonical form piece",
    ...
    ul: 'the "flow-list" layout wrapper plus canonical rows',
